  ...
  describe "encodeMachOSection64" $
    it "encodes section_64 of Mach-O" $ do
      ...
      encodeMachOSection64 (textSection (B.singleton text) off)
        `shouldBe`
        B.pack
          [ 0x5f, 0x5f, 0x74, 0x65 -- __text: section name
          , 0x78, 0x74, 0x00, 0x00
          , 0x00, 0x00, 0x00, 0x00
          , 0x00, 0x00, 0x00, 0x00
          , 0x5f, 0x5f, 0x54, 0x45 -- __TEXT: segment name
          , 0x58, 0x54, 0x00, 0x00
          , 0x00, 0x00, 0x00, 0x00
          , 0x00, 0x00, 0x00, 0x00
          , 0x00, 0x00, 0x00, 0x00 -- address
          , 0x00, 0x00, 0x00, 0x00
          , len , 0x00, 0x00, 0x00 -- size
          , 0x00, 0x00, 0x00, 0x00
          , off , 0x00, 0x00, 0x00 -- offset
          , 0x00, 0x00, 0x00, 0x00 -- align
          , 0x00, 0x00, 0x00, 0x00 -- relocation offset
          , 0x00, 0x00, 0x00, 0x00 -- the number of relocation entries
